                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                            ...
                            <FormSection title={t("complaintForm.information")}>
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <textarea
                                        ...
                                        className="min-h-[120px] w-full rounded-xl border border-input bg-background p-3 text-sm shadow-2xs outline-none transition-[color,box-shadow] focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/20"
                            ...
                            <div className="flex items-center justify-end gap-3 border-t border-border pt-4">
                                <Button variant="outline" type="button" className="rounded-xl px-5 font-semibold" asChild>
