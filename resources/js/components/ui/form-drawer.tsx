        ...
        <>
            <Sheet open={open} onOpenChange={requestChange}>
                <SheetContent side="right" className="w-full gap-0 p-0 sm:max-w-xl">
                    ...
                    <SheetFooter className="sticky bottom-0 border-t border-border/60 bg-popover/95 px-6 py-4 backdrop-blur sm:flex-row sm:justify-end">{footer}</SheetFooter>
                </SheetContent>
            </Sheet>
            ...
            <ConfirmDialog
                ...
                description={t("ui.discardChangesDescription")}
                confirmLabel={t("ui.discard")}
