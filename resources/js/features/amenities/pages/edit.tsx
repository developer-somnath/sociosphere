                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                            <FormSection title={t("amenityForm.generalInformation")}>
                                ...
                                <div className="space-y-1.5">
                                    <Label>{t("amenityForm.status")}</Label>
                                    <select
                                        value={form.data.is_active ? "active" : "inactive"}
                                        onChange={(e) =>
                                            form.setData("is_active", e.target.value === "active")
                                        }
                                        className="h-9.5 w-full rounded-xl border border-input bg-background px-3 text-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                                    >
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <textarea
                                        ...
                                        className="min-h-[80px] w-full rounded-xl border border-input bg-background p-3 text-sm shadow-2xs outline-none transition-[color,box-shadow] focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/20"
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <textarea
                                        ...
                                        className="min-h-[100px] w-full rounded-xl border border-input bg-background p-3 text-sm shadow-2xs outline-none transition-[color,box-shadow] focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/20"
